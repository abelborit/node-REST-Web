...
/* aquí también podría ser una interface, hay algunos que lo crean así, puede ser de la forma en que uno quiera (interface, abstract class, etc) solo que tiene que ser la creación de un objeto que nos exija y obligue a crear otros objetos de una forma determinada o de la forma en la que queremos o esperamos */
